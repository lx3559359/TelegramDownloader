...
def test_v032_version_and_content_runtime_contract_are_consistent() -> None:
    root = Path(__file__).parents[1]
    ...
    assert '__version__ = "0.3.2"' in package_init
    assert '#define AppVersion "0.3.2"' in installer
